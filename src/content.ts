...
function updateCursorPosition(e: MouseEvent) {
  const cursor = document.querySelector('.newThreadCursor') as HTMLElement;
  if (cursor) {
...
function showReaction(message: string) {
...
function promptForComment(x: number, y: number, threadId?: string) {
...
function resetCommentMode() {
  ...
  function createThread(x: number, y: number, comment: string, mentions: string[]) {
  ...
  function addCommentToThread(threadId: string, comment: string, mentions: string[]) {
  ...
  function renderThread(thread: ThreadData) {
  ...
  function renderComment(comment: ThreadComment) {
  ...
  function createReplyForm(threadId: string) {
